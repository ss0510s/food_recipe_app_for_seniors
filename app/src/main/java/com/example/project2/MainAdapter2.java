...
//food activity에서 사용할 adapter
//리사이틀러뷰에 표시할 아이템 뷰 생성
public class MainAdapter2 extends RecyclerView.Adapter<MainAdapter2.MainHolder> implements Filterable {
    private List<ItemList> mDataList;
    private List<ItemList> mDataListAll;

    //각 아이템 뷰에 들어갈 변수
    public MainAdapter2(List<ItemList> items) {
        mDataList=items;
    ...
    public static class MainHolder extends RecyclerView.ViewHolder {
        ...
        public MainHolder(View view) {
            super(view);
            //뷰객체에 대한 참조
            this.main_image = view.findViewById(R.id.image2);
            this.main_text = view.findViewById(R.id.item_text2);
        }
    }
    ...
    public MainHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View holderView = LayoutInflater.from(parent.getContext()).inflate(R.layout.main_holder_view2, parent, false);
